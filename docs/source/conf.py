# -*- coding: utf-8 -*-
#
# Formal documentation build configuration file, created by
...
project = u'Formal'
copyright = u'2013, Rob Britton, 2015-2018 Heiko "riot" Weinen, 2019 Formal Community'
author = u'Rob Britton, Heiko "riot" Weinen, Formal Contributors'
url = u'https://github.com/isomeric/formal'

# Issue tracker info
issues_github_path = 'isomeric/formal'
...
latex_documents = [
    (master_doc, 'Formal.tex', u'Formal Documentation',
     u'Formal Contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'formal', u'Formal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'formal', u'Formal Documentation',
     author, 'Formal', 'The Formal Document Object Mapper.',
     'Miscellaneous'),
]
