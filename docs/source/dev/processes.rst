.. _Issue Tracker: https://github.com/isomeric/formal/issues
...
If you wish to contribute to Formal, please familiarize yourself with SCRUM
...
- New Bug Reports are submitted via:
  https://github.com/isomeric/formal/issues
...
- A `New Pull Request <https://github.com/isomeric/formal/compare/>`_ created with the fix.

  This should contain:
  - A new or modified unit test.
  - A patch that fixes the bug ensuring all unit tests pass.
  - The `Change Log <https://github.com/isomeric/formal/tree/master/CHANGES.rst>`_ updated.
  - Appropriate documentation updated.
- The `Pull Request <https://github.com/isomeric/formal/pulls>`_ is reviewed and approved by at least two other developers.
...
- Submit a `New Issue <https://github.com/isomeric/formal/issues/new>`_
- Write your code.
...
- Update the `Change Log <https://github.com/isomeric/formal/tree/master/CHANGES.rst>`_ appropriately.
- Submit a `New Pull Request <https://github.com/isomeric/formal/compare/>`_.
...
that Formal supports installed in your local environment.
